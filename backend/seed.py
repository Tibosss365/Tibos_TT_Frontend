...
SEED_TICKETS = [
    {"subject": "Laptop won't boot after Windows update", "category": TicketCategory.software, "priority": TicketPriority.high, "status": TicketStatus.open, "submitter_name": "Alice Johnson", "company": "Acme Corp", "contact_name": "Alice Johnson", "email": "alice@acme.com", "description": "Laptop displays blue screen on startup after the latest Windows update."},
    {"subject": "VPN disconnects every 30 minutes", "category": TicketCategory.network, "priority": TicketPriority.medium, "status": TicketStatus.in_progress, "submitter_name": "Bob Smith", "company": "TechStart", "contact_name": "Bob Smith", "email": "bob@techstart.com", "description": "Remote VPN drops connection exactly every 30 minutes requiring manual reconnect."},
    {"subject": "Printer offline – 3rd floor", "category": TicketCategory.hardware, "priority": TicketPriority.low, "status": TicketStatus.resolved, "submitter_name": "Carol White", "company": "Globex", "contact_name": "Carol White", "email": "carol@globex.com", "description": "HP LaserJet on 3rd floor showing offline. Tried power cycling but still offline."},
    {"subject": "Ransomware alert on workstation WS-042", "category": TicketCategory.security, "priority": TicketPriority.critical, "status": TicketStatus.in_progress, "submitter_name": "Dan Martinez", "company": "Initech", "contact_name": "Dan Martinez", "email": "dan@initech.com", "description": "Multiple files encrypted with .locked extension. Workstation isolated from network."},
    {"subject": "Cannot access SharePoint site", "category": TicketCategory.access, "priority": TicketPriority.medium, "status": TicketStatus.open, "submitter_name": "Eve Davis", "company": "Umbrella Ltd", "contact_name": "Eve Davis", "email": "eve@umbrella.com", "description": "Getting 403 Forbidden on the Marketing SharePoint site since yesterday."},
    {"subject": "Outlook not syncing emails", "category": TicketCategory.email, "priority": TicketPriority.high, "status": TicketStatus.open, "submitter_name": "Frank Wilson", "company": "Aperture", "contact_name": "Frank Wilson", "email": "frank@aperture.com", "description": "Outlook 365 stuck on 'Sending/Receiving'. New emails not arriving since this morning."},
    {"subject": "Monitor flickering on Dell OptiPlex", "category": TicketCategory.hardware, "priority": TicketPriority.low, "status": TicketStatus.open, "submitter_name": "Grace Lee", "company": "Acme Corp", "contact_name": "Grace Lee", "email": "grace@acme.com", "description": "24\" Dell monitor flickers intermittently, usually after 1-2 hours of use."},
    {"subject": "Software license expired – AutoCAD", "category": TicketCategory.software, "priority": TicketPriority.high, "status": TicketStatus.on_hold, "submitter_name": "Hank Brown", "company": "Blueprint Co", "contact_name": "Hank Brown", "email": "hank@blueprint.com", "description": "AutoCAD 2024 showing license expired. Engineering team blocked from working."},
    {"subject": "Wi-Fi drops in conference room B", "category": TicketCategory.network, "priority": TicketPriority.medium, "status": TicketStatus.in_progress, "submitter_name": "Iris Taylor", "company": "TechStart", "contact_name": "Iris Taylor", "email": "iris@techstart.com", "description": "Wi-Fi signal very weak in conference room B. Drops during video calls."},
    {"subject": "Password reset – account locked", "category": TicketCategory.access, "priority": TicketPriority.medium, "status": TicketStatus.resolved, "submitter_name": "Jack Anderson", "company": "Globex", "contact_name": "Jack Anderson", "email": "jack@globex.com", "description": "AD account locked after too many failed login attempts. Needs password reset."},
    {"subject": "Suspicious email with attachment received", "category": TicketCategory.security, "priority": TicketPriority.high, "status": TicketStatus.open, "submitter_name": "Karen White", "company": "Initech", "contact_name": "Karen White", "email": "karen@initech.com", "description": "Received email claiming to be from IT with .exe attachment. Did not open. Forwarding to security."},
    {"subject": "Excel macro not running after update", "category": TicketCategory.software, "priority": TicketPriority.medium, "status": TicketStatus.open, "submitter_name": "Liam Clark", "company": "Aperture", "contact_name": "Liam Clark", "email": "liam@aperture.com", "description": "Finance team macros stopped running after Office update KB5002567."},
    {"subject": "New employee workstation setup", "category": TicketCategory.hardware, "priority": TicketPriority.low, "status": TicketStatus.closed, "submitter_name": "Maria Garcia", "company": "Umbrella Ltd", "contact_name": "Maria Garcia", "email": "maria@umbrella.com", "description": "Need workstation configured for new hire starting Monday. Standard software install."},
    {"subject": "Phishing email reported by multiple users", "category": TicketCategory.security, "priority": TicketPriority.high, "status": TicketStatus.in_progress, "submitter_name": "Paul Zhang", "company": "Blueprint Co", "contact_name": "Paul Zhang", "email": "paul@blueprint.com", "description": "Multiple users received fake IT helpdesk email asking for credentials. Investigating origin."},
    {"subject": "CRM application slow performance", "category": TicketCategory.software, "priority": TicketPriority.medium, "status": TicketStatus.open, "submitter_name": "Nina Patel", "company": "Acme Corp", "contact_name": "Nina Patel", "email": "nina@acme.com", "description": "Salesforce CRM taking 10+ seconds to load pages. Affecting sales team productivity."},
]
